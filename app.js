...
/* variáveis */
/*
-variável é um espaço reservado na memória para 
armazenar um valor
...
- a recomendação é que o nome da variável seja simples e significativa, sem caracteres especiais, sem acento, sem espaço e lembrando que o javascript diferencia maiúsculas de minúsculas, isso significa que PrecoVenda é diferente de precovenda
*/
//var nome
let nome = 'João'
let idade = '22'
...
console.log('Sua note é ' + nota1)

/* Tipos */
console.log(typeof nome) // 'João' é string
console.log(typeof idade) // 22 é number
console.log(typeof nota1) // 9.0 é number
...
console.log(10 > 3 || 10 > 15 || 10 > 8) // Operador OU (OR) - com operdor OU apenas uma expressão precisa ser verdadeira para o resultado ser verdadeiro
